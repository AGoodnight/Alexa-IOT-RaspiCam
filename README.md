<p>Modified by Right Brain Networks. So tests are not fully implemented, however it's setup for them.</p>



# Angular 4 Webpack Redux Starter

> Based on Angular 2 Starter kit, Angular 2 has been replaced with Angular 4 in this build. Angular 4 however is still Angular 2, only with some syntax changes. see change logs here: (https://github.com/angular/angular/blob/master/CHANGELOG.md)

> An Angular 4 starter kit featuring [Angular](https://angular.io) ([Router](https://angular.io/docs/js/latest/api/router/), [Forms](https://angular.io/docs/js/latest/api/forms/),
